  ...
  render() {
    ...
    return (
      <Container style={styles.container}>
        <HeaderComponent title="وضعیت حساب"  />
        <Grid>
              ...
              <Card style={{ margin: 2, padding: 3 }}>
                <CardItem >
                  <Row >
                    ...
                    <Col size={20}><Switch value={this.state.hasNotif} onValueChange={()=>this.setState({
                      hasNotif:!this.state.hasNotif
                    })} /></Col>
                  </Row>
                </CardItem>
              </Card>
              <Card style={{ margin: 2, padding: 3 }}>
                <CardItem >
                  <Row >
                    ...
                    <Col size={20}><Switch value={this.state.hasVoice} onValueChange={()=>this.setState({
              ...
              <Card style={{ margin: 2, padding: 3 }}>
                <CardItem >
                  <Row >
                    ...
                    <Col size={20}><Switch value={this.state.hasVibre} onValueChange={()=>{this.setState({
                      hasVibre:!this.state.hasVibre
                    })}}/></Col>
                  </Row>
                </CardItem>
              </Card>
        ...
        <Fab
          position="bottomRight" style={{ backgroundColor: '#7fbbd2' }}
