...
export default class EducationalScreen extends PureComponent {
  ...
  render(){
    ...
    return (
        ...
        <HeaderComponent title="نکات آموزشی"/>
          <Grid>
            <Row style={{ flex: 1 }}><Image source={require('./../../../assets/img/png/header.png')} style={{ height: '100%', width: '100%' }} /></Row>
                  ...
                  <Col size={7}>
                      ...
                      <Row size={5}>
                        <Col style={{ padding:5,flex:1}}>
                          <Button block style={{ height:buttonSize,width:buttonSize,backgroundColor: '#999a9b', borderRadius: 30 }}>
                            <SvgUri
                                ...
                                height="80"
                                    ...
                                    // source={require('./../../../assets/img/svg/picture.svg')}
                                    fill='#ffffff'
                                />
                      ...
                      <Row size={5} >
                          ...
                          <Col style={{ padding:5,flex:1}}>
                            <Button block style={{ height:buttonSize,width:buttonSize,backgroundColor: '#808182', borderRadius: 30 }}>
                              <SvgUri
                              style={{justifyContent:'center',alignSelf:'center'}}
                              width="80"
                              height="80"
